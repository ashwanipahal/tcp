...
import OrderDetailsReducer from '@tcp/core/src/components/features/account/OrderDetails/container/OrderDetails.reducer';
...
const rootReducer = combineReducers({
  ...
  [ORDERDETAILS_REDUCER_KEY]: OrderDetailsReducer,
