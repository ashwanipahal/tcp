...
// ProductListTabs reducer
export const PRODUCT_LIST_TABS_REDUCER_KEY = 'ProductListTabs';
export const PRODUCT_LIST_TABS_ACTION_PATTERN = '@@ProductListTabs-';
...
export const REDUCER_ACTION_MAPPING = {
  ...
  [PRODUCT_LIST_TABS_REDUCER_KEY]: PRODUCT_LIST_TABS_ACTION_PATTERN,
};
