...
const renderOrderDetailView = (orderDetailsData, ordersLabels) => {
  const {
    summary,
    orderStatus,
    purchasedItems,
...
class OrderDetailsView extends PureComponent {
  render() {
    const { orderDetailsData, className, ordersLabels, isFetching, isLoggedIn } = this.props;
    return (
      <div className={className}>
        ...
        {!isFetching && renderOrderDetailView(orderDetailsData, ordersLabels)}
      </div>
    );
  }
}
