...
import { getError, getChangePasswordLabels , getChangeErrorMessage } from './ChangePassword.selectors';
...
export class ChangePasswordContainer extends PureComponent {
  ...
  render() {
    const { successMessage, errorMessage, labels, onClose, formErrorMessage , changeErrorMessage } = this.props;
    return (
