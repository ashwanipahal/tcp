...
export const modalStyles = css`
  ...
  .table-image {
    display: flex;
    justify-content: center;
    background: transparent url(${getStaticFilePath('/images/BenefitImageV.png')}) no-repeat 0 0;
    background-size: contain;
    ...
    margin: ${props => props.theme.spacing.ELEM_SPACING.LRG} auto;
    @media ${props => props.theme.mediaQuery.medium} {
      background: transparent url(${getStaticFilePath('/images/BenefitImageH.png')}) no-repeat 0 0;
      height: 300px;
      background-size: contain;
    }
  }
