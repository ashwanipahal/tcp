...
const getMakeDefaultBadge = ({ card, labels, setDefaultPaymentMethod }: MakeDefaultProps) => {
  return card.defaultInd ? (
    <DefaultBadgeWrapper>
      <BadgeContent>
        <BodyCopy
          ...
          fontWeight="semibold"
          fontSize="fs10"
          text={labels.paymentGC.ACC_LBL_DEFAULT_PAYMENT}
        />
      </BadgeContent>
    </DefaultBadgeWrapper>
  ) : (
    <Anchor
      ...
      text={labels.paymentGC.ACC_LBL_MAKE_DEFAULT}
    />
  );
};
        ...
        <CardCtaLinkLeftMargin>
          {!isVenmo && (
            <Anchor
              ...
              text={labels.paymentGC.ACC_LBL_EDIT}
            />
          )}
        </CardCtaLinkLeftMargin>
        <Anchor
          ...
          text={labels.paymentGC.ACC_LBL_DELETE}
        />
      </CardCtaLinks>
    </CardTileWrapper>
  );
