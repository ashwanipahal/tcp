...
const PAYMENT_CONSTANTS = {
  ...
  CLEAR_CARD_BALANCE: `${PAYMENT_ACTION_PATTERN}CLEAR_CARD_BALANCE`,
  ...
  FETCH_MODULEX_CONTENT: `${PAYMENT_ACTION_PATTERN}FETCH_MODULEX_CONTENT`,
  SET_MODULEX_CONTENT: `${PAYMENT_ACTION_PATTERN}ADD_MODULEX_CONTENT`,
};
