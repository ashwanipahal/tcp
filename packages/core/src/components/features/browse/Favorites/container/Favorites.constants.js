...
const FAVORITES_REPLACE_WISHLIST_ITEM = `${FAVORITES_ACTION_PATTERN}FAVORITES_REPLACE_WISHLIST_ITEM`;
const MAXIMUM_PRODUCT_ADDED_ERROR = `${FAVORITES_ACTION_PATTERN}MAXIMUM_PRODUCT_ADDED_ERROR`;
const RESET_MAXIMUM_PRODUCT_ADDED_ERROR = `${FAVORITES_ACTION_PATTERN}RESET_MAXIMUM_PRODUCT_ADDED_ERROR`;
const FAVORITES_SET_DEFAULT_WISHLIST = `${FAVORITES_ACTION_PATTERN}FAVORITES_SET_DEFAULT_WISHLIST`;
...
const FAVORITES_CONSTANTS = {
  ...
  FAVORITES_REPLACE_WISHLIST_ITEM,
  MAXIMUM_PRODUCT_ADDED_ERROR,
  RESET_MAXIMUM_PRODUCT_ADDED_ERROR,
  FAVORITES_SET_DEFAULT_WISHLIST,
};
