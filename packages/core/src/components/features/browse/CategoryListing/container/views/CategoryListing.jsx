...
const CategoryListing = props => {
  ...
  useEffect(() => {
    if (breadCrumbTrail && breadCrumbTrail.length) {
      trackPageLoad(getProductListingPageTrackData(breadCrumbTrail));
    }
  }, [breadCrumbTrail]);
  ...
  return (
    <div className={className}>
      <Grid className={className}>
        ...
        <Row>
          <Col colSize={{ large: 2, medium: 0, small: 0 }} hideCol={{ small: true, medium: true }}>
          ...
          <Col colSize={{ large: 10, medium: 8, small: 6 }}>
            <Row fullBleed>
              ...
              <Col className="clp-spotlight-container" colSize={{ small: 6, medium: 8, large: 12 }}>
