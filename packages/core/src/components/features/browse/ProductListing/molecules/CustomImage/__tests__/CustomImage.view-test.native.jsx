...
import ImageComp from "../views/CustomImage.view.native";
      ...
      colorsMap: [
        {
          ...
          color: {
            name: "WHITE",
            imagePath:
              "/wcsstore/GlobalSAS/images/tcp/products/swatches/3000785_10.jpg"
          }
        }
      ],
      imagesByColor: {
        WHITE: {
          basicImageUrl:
            "/wcsstore/GlobalSAS/images/tcp/products/500/3000785_10.jpg",
          extraImages: [
            {
              isOnModalImage: false,
              iconSizeImageUrl:
                "/wcsstore/GlobalSAS/images/tcp/products/125/3000785_10.jpg"
            }
          ]
        }
      },
