...
export default function CheckoutReducer(checkout = initialState, action) {
  ...
  switch (action.type) {
    case 'CHECKOUT_VALUES_SET_PICKUP':
      return merge(orderValues, { pickUpContact: action.pickUpContact });
    case 'CHECKOUT_VALUES_SET_PICKUP_ALT':
      return merge(orderValues, { pickUpAlternative: action.pickUpAlternative });
    case 'CHECKOUT_VALUES_SET_GIFTCARDS':
      return merge(orderValues, { giftCards: action.giftCards });
    case 'CHECKOUT_VALUES_SET_SHIPPING':
      return merge(orderValues, { shipping: action.shipping });
    ...
    //   setVenmoProgressLocalStorage(action.payload);
    ...
    //     setVenmoProgressLocalStorage(result)
