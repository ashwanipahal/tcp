...
import ModuleQ from '../container/ModuleQ.container';
...
describe('ModuleSVanilla', () => {
  ...
  describe('ModuleQ component', () => {
    ...
    it('Module has header', () => {
      expect(ModuleQComp.find('.moduleQ-header')).toHaveLength(0);
    });

    it('Module has promo banner', () => {
      expect(ModuleQComp.find('.moduleQ-promo')).toHaveLength(0);
    });
  });
});
