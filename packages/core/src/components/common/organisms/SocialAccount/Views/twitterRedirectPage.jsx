...
import { getAuthToken } from './twitterDynamicAbstractor';
      ...
      window.addEventListener('load', () => {
        ...
        if (token && verifier) {
          let parentWindow = window.opener,
            ...
            parentTextTokenField = null,
            parentTextVerifierField,
            parentSetTokenField;
        ...
        //s If the twitter authorization is denied
        else if (denied) {
          ...
          if (window.opener.document.getElementById('twitter-token')) {
            ...
            window.location = `${getLocationOrigin()}/${getSiteId()}${
              config.ACCOUNT_REDIRECT.PREFERENCE
            }`;
          }
        }
