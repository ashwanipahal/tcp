...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    ariaPrevious: getLabelValue(state.Labels, 'PREVIOUS_ARIA_LABEL', 'recommendations', 'global'),
    ariaNext: getLabelValue(state.Labels, 'NEXT_ARIA_LABEL', 'recommendations', 'global'),
